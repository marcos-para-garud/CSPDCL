    ...
    <div className="bg-[#274699] p-8">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-2">
        ...
        <div className="text-left">
          ...
          <div className='text-white font-semibold'>GST Identification No.-<span className='text-sm font-normal'>22AADCC6047KIZR</span></div>
          <div className='text-white font-semibold'>Registration No.-<span className='text-sm font-normal'>U40108 CT 2003 PLC 15822</span></div>
        ...
        <div className="text-center sm:ml-24">
          ...
          <ul className="mb-4 text-left text-base font-thin">
            <li className='my-2'><a href="#" className="text-white hover:underline">Sitemap</a></li>
            <li className='my-2'><a href="#" className="text-white hover:underline">Customer e-seva</a></li>
            <li className='my-2'><a href="#" className="text-white hover:underline">Customer Services</a></li>
            <li className='my-2'><a href="#" className="text-white hover:underline">Online new connection</a></li>
            <li className='my-2'><a href="#" className="text-white hover:underline">Solar rooftop portal</a></li>
            <li className='my-2'><a href="#" className="text-white hover:underline">Employee app download</a></li>
          </ul>
        ...
        <div className="text-left sm:ml-20">
          ...
          <ul className="mb-4 text-left text-sm font-thin">
            ...
            <li className='my-2 text-white'>ई –मेल : customercare1912@cspc.co.in</li>
          </ul>
          <div className="flex justify-start space-x-4">
