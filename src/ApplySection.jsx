...
// //       {/* Box 1 */}
// //       <div className="md:w-1/2 m-0 w-full p-8 bg-[#274699] flex flex-col justify-center">
...
// //         </p>
// //         <button className="bg-red-600 text-white w-full md:w-40 py-2 px-4 rounded hover:bg-blue-600">
// //           Apply Now
// //         </button>
// //       </div>
...
// //         <img src={apply} alt="Solar Panels" className="w-full h-full object-cover m-0 p-0" />
// //       </div>
// //     </div>
// //   );
// // };
...
//     <div className="flex flex-col md:flex-row w-full">
//       {/* Box 1 */}
//       <div className="md:w-1/2 w-full p-8 bg-[#274699] flex flex-col justify-center">
//         <h2 className="text-2xl md:text-4xl text-white font-bold mb-4">
//           Apply for Kusum Yojna Today and Get Solar Panels
//         </h2>
//         <p className="text-base md:text-lg text-white mb-6">
